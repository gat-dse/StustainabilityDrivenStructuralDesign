...
excel_file = "260506_Datenbankdefinition_min_max.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("database_260506_min_max.db") #name of database
