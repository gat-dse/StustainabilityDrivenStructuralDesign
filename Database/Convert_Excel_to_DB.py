...
excel_file = "260805_Datenbankdefinition.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("../260513_Betonartikel/database_260805.db") #name of database
