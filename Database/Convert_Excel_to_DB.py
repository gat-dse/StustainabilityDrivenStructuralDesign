...
excel_file = "260506_Datenbankdefinition_Hochbau.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("database_260506_Hochbau.db") #name of database
