...
excel_file = "260610_Datenbankdefinition_Hochbau.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("../260513_Betonartikel/database_260610_Hochbau_neu.db") #name of database
