...
excel_file = "260811_Datenbankdefinition.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("database_260811.db") #name of database
