...
excel_file = "260506_Datenbankdefinition.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("database_260506.db") #name of database
