...
excel_file = "260617_Datenbankdefinition_Hochbau.xlsx"   #name of excel file. must be in same directory as code
...
conn = sqlite3.connect("../260513_Betonartikel/database_260617_Hochbau.db") #name of database
