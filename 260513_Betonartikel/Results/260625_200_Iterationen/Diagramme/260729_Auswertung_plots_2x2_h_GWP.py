...
legend_label_mapping_DE = {
    ...
    'BeamSimpleSup_rc_rib_Schuettung': 'Rippenplatte, einachsig tragend, einfach gelagert\n(Standardaufbau + Schüttung)',
...
def generate_kriterien_matrix(data_subset, system_filter_string, haupt_titel):
    ...
    filename = f"Kriterienmatrix_{haupt_titel.replace(' ', '_')}_{x_min}-{x_max}m_{Sprache}.png"
