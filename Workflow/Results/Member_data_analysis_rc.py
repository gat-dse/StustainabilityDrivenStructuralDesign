...
demselben Rohformat, wie es struct_analysis.py exportiert.

Diagramme:
1. Biegewiderstand unten mu_max (MRd) vs. Bemessungsmoment positiv mEd_p
2. Biegewiderstand oben mu_min (MRd) vs. Bemessungsmoment negativ mEd_n
3. Querkraftwiderstand vu_p (VRd) vs. Bemessungsquerkraft vEd
4. Rissmoment mr_p vs. mkd_p (positive Biegung)
5. Rissmoment mr_n vs. mkd_n (negative Biegung)
