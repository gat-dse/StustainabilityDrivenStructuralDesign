"""
Liest die Members_rc_rec_simple_massiv-Datenbank ein und stellt fuer jeden Member das
...
fig.savefig("SimpleMassiv_hd_calc.png", dpi=300, bbox_inches="tight")
fig.savefig("SimpleMassiv_hd_calc.pdf", bbox_inches="tight")
print("Diagramm gespeichert: SimpleMassiv_hd_calc.png / .pdf")
