...
fig.savefig("SimpleMassiv_roh_rohs.png", dpi=300, bbox_inches="tight")
fig.savefig("SimpleMassiv_roh_rohs.pdf", bbox_inches="tight")
print("Diagramm gespeichert: SimpleMassiv_roh_rohs.png / .pdf")
