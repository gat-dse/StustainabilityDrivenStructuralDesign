...
fig.savefig("SimpleMassiv_fwger_phi2.png", dpi=300, bbox_inches="tight")
fig.savefig("SimpleMassiv_fwger_phi2.pdf", bbox_inches="tight")
print("Diagramm gespeichert: SimpleMassiv_fwger_phi2.png / .pdf")
