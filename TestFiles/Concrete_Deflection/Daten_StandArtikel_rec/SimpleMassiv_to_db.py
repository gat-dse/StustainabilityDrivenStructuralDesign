"""
Liest die Rohdaten-Excel "Members_rc_rec_simple_massiv.xlsx" (Sheet "Members_Comparison") ein.
Anders als bei der 260603-Datei liegen hier ALLE Rohattribute vor (Spalte 'key' + 'level',
je eine Spalte pro Member), inkl. vieler nicht benoetigter Zeilen.
...
wie 260603_Members_rc_rec_2_10Iterationen_Sheet2.db, damit dieselben Plot-Skripte
...
- 'prod_id' und 'GWP' (jeweils level 2) kommen je zweimal vor: 1. Vorkommen = Beton
  (unter 'concrete_type'), 2. Vorkommen = Bewehrung (unter 'rebar_type'). Es werden
  beide getrennt als *_concrete / *_rebar gespeichert.
"""
import sqlite3
...
excel_file = "Members_rc_rec_simple_massiv.xlsx"
sheet_name = "Members_Comparison"
db_file = "Members_rc_rec_simple_massiv.db"
table_name = "members"

# ==============================================================================
# EINLESEN & BENOETIGTE ZEILEN FINDEN (erstes Vorkommen je Key, da einige Keys mehrfach vorkommen)
# ==============================================================================
