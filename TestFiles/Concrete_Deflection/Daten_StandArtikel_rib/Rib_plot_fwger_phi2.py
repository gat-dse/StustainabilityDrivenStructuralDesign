...
fig.savefig("Rib_fwger_phi2.png", dpi=300, bbox_inches="tight")
fig.savefig("Rib_fwger_phi2.pdf", bbox_inches="tight")
print("Diagramm gespeichert: Rib_fwger_phi2.png / .pdf")
