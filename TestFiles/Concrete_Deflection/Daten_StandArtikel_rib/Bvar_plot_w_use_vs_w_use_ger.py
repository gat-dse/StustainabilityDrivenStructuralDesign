...
fig.savefig("Bvar_w_use_vs_w_use_ger.png", dpi=300, bbox_inches="tight")
fig.savefig("Bvar_w_use_vs_w_use_ger.pdf", bbox_inches="tight")
print("Diagramm gespeichert: Bvar_w_use_vs_w_use_ger.png / .pdf")
