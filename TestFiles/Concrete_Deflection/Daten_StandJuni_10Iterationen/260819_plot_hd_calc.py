"""
Liest die transponierte Sheet2-Datenbank ein und stellt fuer jeden Member das
Verhaeltnis h/d_calc dar.
...
fig.savefig("260819_hd_calc.png", dpi=300, bbox_inches="tight")
fig.savefig("260819_hd_calc.pdf", bbox_inches="tight")
print("Diagramm gespeichert: 260819_hd_calc.png / .pdf")
