...
fig.savefig("260819_roh_rohs.png", dpi=300, bbox_inches="tight")
fig.savefig("260819_roh_rohs.pdf", bbox_inches="tight")
print("Diagramm gespeichert: 260819_roh_rohs.png / .pdf")
